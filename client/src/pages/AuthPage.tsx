        ...
        <div className="grid min-h-screen grid-cols-1 lg:grid-cols-2">
            ...
            <div className="relative hidden overflow-hidden lg:block bg-neutral-900">
                ...
                <div className="absolute left-8 top-8 inline-flex items-center z-10">
                    <img src="https://i.imgur.com/Uf0uM26.png" alt="Altare Logo" className="h-8" />
                </div>
            ...
            <div className="flex items-center justify-center px-6 py-10 lg:px-12">
                <div className="w-full max-w-md">
                    <div className="p-0.5 bg-gray-200/50 rounded-lg">
                    <div className="px-2 py-2 flex items-center gap-2">
                        <LockClosedIcon className="h-4 w-4 text-gray-600/30" />
                        <span className="text-xs text-gray-700 font-semibold">Authentication required</span>
                    </div>
                    <Card>
                        <CardHeader>
                            {mode === 'login' ? (
                                <>
                                    <CardTitle className="flex items-center gap-2">Welcome home</CardTitle>
                                    <CardDescription>Sign into your account</CardDescription>
                                </>
                            ) : (
                                <>
                                    <CardTitle className="flex items-center gap-2">Create an account</CardTitle>
